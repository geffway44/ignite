<div class="mb-4">
    ...
    <input id="name" type="text" class="form-input @error('name') is-invalid @enderror" name="name" value="{{ old('name') ?? ($user->name ?? null) }}" required autocomplete="name" placeholder="Name">
